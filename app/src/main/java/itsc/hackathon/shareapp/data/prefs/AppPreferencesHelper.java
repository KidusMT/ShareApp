...
package itsc.hackathon.shareapp.data.prefs;
...
//        String userId = //String.valueOf(AppConstants.NULL_INDEX));
        return mPrefs.getString(PREF_KEY_CURRENT_USER_ID, "");
    }

    @Override
    public void setCurrentUserId(String userId) {
//        String id = userId == null ? String.valueOf(AppConstants.NULL_INDEX) : userId;
